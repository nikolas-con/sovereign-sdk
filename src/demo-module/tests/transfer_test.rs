...
fn transfer_initial_token() {
    ...
    // Non existent token
    {
        ...
        // println!("{:?}", message_2);
        assert!(message_2
            .starts_with("Value not found for prefix: \"demo_module/BankA/tokens/\" and: storage key"));
    }
    ...
    // Sender does not exist
    {
        ...
        let expected_message_part = format!(
            "Value not found for prefix: \"demo_module/BankA/tokens/{}\" and: storage key",
            token_address
        );
